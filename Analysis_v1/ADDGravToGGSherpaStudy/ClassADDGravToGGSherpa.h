...
// Mon May 21 01:58:29 2018 by ROOT version 6.06/01
// from TChain diphoton/fTree/
//////////////////////////////////////////////////////////

#ifndef ClassADDGravToGGSherpa_h
#define ClassADDGravToGGSherpa_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ClassADDGravToGGSherpa(TTree *tree=0);
   virtual ~ClassADDGravToGGSherpa();
...
#ifdef ClassADDGravToGGSherpa_cxx
ClassADDGravToGGSherpa::ClassADDGravToGGSherpa(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/ADDGravToGG/ADDGravToGG_MS-4000_NED-4_KK-1_M-200-4000/ADDGravToGG_MS-4000_NED-4_KK-1_M-1000To2000_13TeV-sherpaout.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/ADDGravToGG/ADDGravToGG_MS-4000_NED-4_KK-1_M-200-4000/ADDGravToGG_MS-4000_NED-4_KK-1_M-2000To4000_13TeV-sherpaout.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/ADDGravToGG/ADDGravToGG_MS-4000_NED-4_KK-1_M-200-4000/ADDGravToGG_MS-4000_NED-4_KK-1_M-200To500_13TeV-sherpaout.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/ADDGravToGG/ADDGravToGG_MS-4000_NED-4_KK-1_M-200-4000/ADDGravToGG_MS-4000_NED-4_KK-1_M-500To1000_13TeV-sherpaout.root/diphoton/fTree");
      tree = chain;
#endif // SINGLE_TREE
...
ClassADDGravToGGSherpa::~ClassADDGravToGGSherpa()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ClassADDGravToGGSherpa::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassADDGravToGGSherpa::LoadTree(Long64_t entry)
{
...
void ClassADDGravToGGSherpa::Init(TTree *tree)
{
...
Bool_t ClassADDGravToGGSherpa::Notify()
{
...
void ClassADDGravToGGSherpa::Show(Long64_t entry)
{
...
Int_t ClassADDGravToGGSherpa::Cut(Long64_t entry)
{
...
#endif // #ifdef ClassADDGravToGGSherpa_cxx
