...
// Wed Jun 20 10:59:37 2018 by ROOT version 6.06/01
...
#ifdef ClassGG_cxx
ClassGG::ClassGG(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/GGMerged1000To2000out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/GGMerged2000To4000out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/GGMerged200To500out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/GGMerged4000To8000out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/GGMerged500To1000out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/GGMerged8000To13000out.root/diphoton/fTree");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t ClassGG::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassGG::LoadTree(Long64_t entry)
{
...
void ClassGG::Show(Long64_t entry)
{
...
Int_t ClassGG::Cut(Long64_t entry)
{
