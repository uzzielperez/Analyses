...
// Tue Feb 13 15:18:59 2018 by ROOT version 6.06/01
...
#ifdef ClassBKG_cxx
ClassBKG::ClassBKG(TTree *tree) : fChain(0) 
{
...
Int_t ClassBKG::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassBKG::LoadTree(Long64_t entry)
{
...
void ClassBKG::Show(Long64_t entry)
{
...
Int_t ClassBKG::Cut(Long64_t entry)
{
