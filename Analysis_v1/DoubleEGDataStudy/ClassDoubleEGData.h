...
// Sat Mar 17 22:47:51 2018 by ROOT version 6.06/01
// from TChain diphoton/fTree/
//////////////////////////////////////////////////////////

#ifndef ClassDoubleEGData_h
#define ClassDoubleEGData_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ClassDoubleEGData(TTree *tree=0);
   virtual ~ClassDoubleEGData();
...
#ifdef ClassDoubleEGData_cxx
ClassDoubleEGData::ClassDoubleEGData(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Run2016Data-Merged/DoubleEG__Run2016B-03Feb2017_ver2-v2__MINIAOD/out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Run2016Data-Merged/DoubleEG__Run2016C-03Feb2017-v1__MINIAOD/out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Run2016Data-Merged/DoubleEG__Run2016D-03Feb2017-v1__MINIAOD/out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Run2016Data-Merged/DoubleEG__Run2016E-03Feb2017-v1__MINIAOD/out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Run2016Data-Merged/DoubleEG__Run2016F-03Feb2017-v1__MINIAOD/out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Run2016Data-Merged/DoubleEG__Run2016G-03Feb2017-v1__MINIAOD/out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Run2016Data-Merged/DoubleEG__Run2016H-03Feb2017_ver2-v1__MINIAOD/out.root/diphoton/fTree");
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Run2016Data-Merged/DoubleEG__Run2016H-03Feb2017_ver3-v1__MINIAOD/out.root/diphoton/fTree");
      tree = chain;
#endif // SINGLE_TREE
...
ClassDoubleEGData::~ClassDoubleEGData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ClassDoubleEGData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassDoubleEGData::LoadTree(Long64_t entry)
{
...
void ClassDoubleEGData::Init(TTree *tree)
{
...
Bool_t ClassDoubleEGData::Notify()
{
...
void ClassDoubleEGData::Show(Long64_t entry)
{
...
Int_t ClassDoubleEGData::Cut(Long64_t entry)
{
...
#endif // #ifdef ClassDoubleEGData_cxx
