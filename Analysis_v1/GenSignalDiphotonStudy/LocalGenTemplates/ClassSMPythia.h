...
// Thu Mar 21 12:27:17 2019 by ROOT version 6.12/07
// from TChain demo/fgenTree/
//////////////////////////////////////////////////////////

#ifndef ${ClassDiphoton}_h
#define ${ClassDiphoton}_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ${ClassDiphoton}(TTree *tree=0);
   virtual ~${ClassDiphoton}();
...
#ifdef ${ClassDiphoton}_cxx
${ClassDiphoton}::${ClassDiphoton}(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      //chain->Add("/uscms_data/d3/cuperez/DiphotonEXO/CMSSW_10_2_1/src/Analyses/Analysis_v1/Pythia-Sherpa/StandardModelTemplates/TestSM_pT70_M-500-1000_py_GEN.root/demo/fgenTree");
      chain->Add("${eosdsetdir}");
      tree = chain;
#endif // SINGLE_TREE
...
${ClassDiphoton}::~${ClassDiphoton}()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ${ClassDiphoton}::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ${ClassDiphoton}::LoadTree(Long64_t entry)
{
...
void ${ClassDiphoton}::Init(TTree *tree)
{
...
void ${ClassDiphoton}::Show(Long64_t entry)
{
...
Int_t ${ClassDiphoton}::Cut(Long64_t entry)
{
...
#endif // #ifdef ${ClassDiphoton}_cxx
