...
if W_narrow:
	...
	if isHeavyHiggs:
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_0p014_M_1250.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_0p014_M_1500.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_0p014_M_2250.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_0p014_M_2500.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_0p014_M_3000.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_0p014_M_3500.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_0p014_M_5000.root")
...
if W_medium:
	...
	if isHeavyHiggs:
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_1p4_M_1000.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_1p4_M_1750.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_1p4_M_2000.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_1p4_M_2250.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_1p4_M_2500.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_1p4_M_3000.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_1p4_M_4000.root")
if W_wider:
	if isRSG_model:
	...
	if isHeavyHiggs:
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_5p6_M_1000.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_5p6_M_1750.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_5p6_M_2000.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_5p6_M_2500.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_5p6_M_3500.root")
		DATASET.append("../ResonanceTemplates/OUTGluGluSpin0ToGammaGamma_W_5p6_M_4500.root")
if doSM:
	DATASETSM = []
...
for dset in DATASET:
	for var in obj:
		if doSM:
			...
			if "gen" in var:
				PlotResonance(var, dset, color=2, outputdir="make", Background=None, lumi=137)
			else:
				PlotResonance(var, dset, color=2, outputdir="make", Background=SMhistlabeltuple, lumi=137)
		else:
