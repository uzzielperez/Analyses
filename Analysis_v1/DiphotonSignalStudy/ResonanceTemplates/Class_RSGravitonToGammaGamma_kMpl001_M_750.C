#define Class_RSGravitonToGammaGamma_kMpl001_M_750_cxx
#include "Class_RSGravitonToGammaGamma_kMpl001_M_750.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void Class_RSGravitonToGammaGamma_kMpl001_M_750::Loop()
{
   if (fChain == 0) return;
   ...
   TString fileout_name = "OUTRSGravitonToGammaGamma_kMpl001_M_750.root";
