...
mass, e_barrel, e_EBorBE, etotal = readCSV_eff( 'RSG75_AN.csv' )
mass125, e125_barrel, e125_EBorBE, e125total = readCSV_eff( 'RSG125_AN.csv') 
...
c1.Draw()
tag = inputfile[3:-4]
c1.SaveAs("rsg_eff_cms_750-7000_%s_ratio.pdf" %(tag))
