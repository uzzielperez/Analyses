...
// Thu Sep 27 00:35:04 2018 by ROOT version 6.12/07
...
Int_t ClassRSG::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassRSG::LoadTree(Long64_t entry)
{
...
void ClassRSG::Show(Long64_t entry)
{
...
Int_t ClassRSG::Cut(Long64_t entry)
{
