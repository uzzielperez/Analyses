...
// Tue Feb 13 16:14:03 2018 by ROOT version 6.06/01
// from TChain diphoton/fTree/
//////////////////////////////////////////////////////////

#ifndef ClassGGJets_h
#define ClassGGJets_h
...
#ifdef ClassGGJets_cxx
ClassGGJets::ClassGGJets(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Summer16-GGJets-Merge/GGJets_M-8000To13000_Pt-50_13TeV-sherpa.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Summer16-GGJets-Merge/GGJets_M-8000To13000_Pt-50_13TeV-sherpa.root");
      }
...
ClassGGJets::~ClassGGJets()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ClassGGJets::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassGGJets::LoadTree(Long64_t entry)
{
...
void ClassGGJets::Init(TTree *tree)
{
...
void ClassGGJets::Show(Long64_t entry)
{
...
Int_t ClassGGJets::Cut(Long64_t entry)
{
