...
for dset in DATASET:
    ...
    #print "Analyzed %s" %(dset), ". Deleting files."

    # deleteClassFiles_cmd = "rm %s*" %(classname)
    # os.system(deleteClassFiles_cmd)
    #
    # deleteAnalyzeFiles_cmd = "rm analyze_%s.C" %(classname)
    # os.system(deleteAnalyzeFiles_cmd)
