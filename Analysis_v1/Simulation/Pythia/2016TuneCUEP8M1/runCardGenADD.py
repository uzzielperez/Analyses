...
parser.add_argument('-t', '--template', help='Choose Run Card template.', type=str,
			default='TemplatePythia8ADDcfioldTUNE.py')
...
# RunCard_outName = 'ADDGravToGG_NegInt-%d_LambdaT-%d_M-%dTo%d_TuneCP2_%dTeV-pythia8_cfi.py' %(negInt, int(lambdaT), massMin, massMax, COM)
...
os.chdir('CUEP8M1fragments')
# os.chdir('CP2ADDfragments')
