...
while i < len(width):
	for m in M[i]:
		...
		genfrag = 'GluGluSpin0ToGammaGamma_W_%s_M_%d_TuneCP5_13TeV_pythia8_cfi.py' %(width[i], m)	
		dataset = 'GluGluSpin0ToGammaGamma_W_%s_M_%d_TuneCP5_13TeV_pythia8' %(width[i], m)	
