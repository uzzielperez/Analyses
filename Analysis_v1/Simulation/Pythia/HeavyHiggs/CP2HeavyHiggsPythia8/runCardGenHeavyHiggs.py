...
parser.add_argument('-t', '--template', help='Choose Run Card template.', type=str,
			default='TemplateHeavyHiggs_TuneCP2_13TeV_pythia8_cfi.py')
...
#GluGluSpin0ToGammaGamma_W_5p6_M_750_TuneCP2_13TeV_pythia8_cfi.py 
RunCard_outName = 'GluGluSpin0ToGammaGamma_W_%s_M_%d_TuneCP2_%dTeV_pythia8_cfi.py' %(width, m0, COM) 
