...
parser.add_argument('-s', '--spin', default="2",
 		    help='Spin 0 or spin 2')
...
RunCard_outName = 'STest%sUnp%s_spin-%s_M_%s.py' %(du_label, lambdau_label, spin, massrange) 
filein = open(RunCardTemplate)

os.chdir('testfragCPX')
