...
while i < len(k):
	for m in M[i]:
		...
		dataset = 'RSGravitonToGammaGamma_kMpl%s_M_%s_TuneCP5_13TeV_pythia8' %(coupling, m)
		genfrag = 'RSGravitonToGammaGamma_kMpl%s_M_%s_TuneCP5_13TeV_pythia8_cfi.py' %(coupling, m)	
