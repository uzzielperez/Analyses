...
// Sun Feb 18 00:14:14 2018 by ROOT version 6.06/01
// from TChain diphoton/fTree/
//////////////////////////////////////////////////////////

#ifndef ClassGGJetsAdj1_h
#define ClassGGJetsAdj1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ClassGGJetsAdj1(TTree *tree=0);
   virtual ~ClassGGJetsAdj1();
...
#ifdef ClassGGJetsAdj1_cxx
ClassGGJetsAdj1::ClassGGJetsAdj1(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
	...
	//Summer16-GGJets-Merge
      ...
      chain->Add("root://cmsxrootd.fnal.gov//store/user/cuperez/DiPhotonAnalysis/Summer16_GGJets_Merged/GGJets_M-4000To6000_Pt-50_13TeV-sherpa.root/diphoton/fTree");
...
ClassGGJetsAdj1::~ClassGGJetsAdj1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ClassGGJetsAdj1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassGGJetsAdj1::LoadTree(Long64_t entry)
{
...
void ClassGGJetsAdj1::Init(TTree *tree)
{
...
void ClassGGJetsAdj1::Show(Long64_t entry)
{
...
Int_t ClassGGJetsAdj1::Cut(Long64_t entry)
{
...
#endif // #ifdef ClassGGJetsAdj1_cxx
