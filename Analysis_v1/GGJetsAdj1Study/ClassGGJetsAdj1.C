#define ClassGGJetsAdj1_cxx
#include "ClassGGJetsAdj1.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
using namespace std;
void ClassGGJetsAdj1::Loop()
{
//   In a ROOT session, you can do:
//      root> .L ClassGGJetsAdj1.C
//      root> ClassGGJetsAdj1 t
...
//      if (jentry%10000 == 0) cout << "Number of processed events: " << jentry << "; LumiWts " << lumiWts[jentry]<< " " << Event_weightAll <<  endl;
     ...
     if (jentry%10000 == 0) cout << "Number of processed events: " << jentry << " Lumiwts: "<< Event_weightLumi << endl;	     
      if (isGood){ 
        nPassisGood++;
  ...
  TFile file_out("GGJets2_histograms.root","RECREATE");
