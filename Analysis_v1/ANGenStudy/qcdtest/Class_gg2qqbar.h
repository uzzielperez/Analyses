...
#ifndef Class_gg2qqbar_h
#define Class_gg2qqbar_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Class_gg2qqbar(TTree *tree=0);
   virtual ~Class_gg2qqbar();
...
#ifdef Class_gg2qqbar_cxx
Class_gg2qqbar::Class_gg2qqbar(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/uscms_data/d3/cuperez/CMSSW_9_3_8/src/multiphoton-analysis/nPhotonAnalyzer/out/Testqcd_gg2qqbar_TuneCP2_py_GEN.root/demo/fgenTree");
...
Class_gg2qqbar::~Class_gg2qqbar()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Class_gg2qqbar::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Class_gg2qqbar::LoadTree(Long64_t entry)
{
...
void Class_gg2qqbar::Init(TTree *tree)
{
...
void Class_gg2qqbar::Show(Long64_t entry)
{
...
Int_t Class_gg2qqbar::Cut(Long64_t entry)
{
...
#endif // #ifdef Class_gg2qqbar_cxx
