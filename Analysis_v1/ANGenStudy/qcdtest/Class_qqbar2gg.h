...
#ifndef Class_qqbar2gg_h
#define Class_qqbar2gg_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Class_qqbar2gg(TTree *tree=0);
   virtual ~Class_qqbar2gg();
...
#ifdef Class_qqbar2gg_cxx
Class_qqbar2gg::Class_qqbar2gg(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/uscms_data/d3/cuperez/CMSSW_9_3_8/src/multiphoton-analysis/nPhotonAnalyzer/out/Testqcd_qqbar2gg_TuneCP2_py_GEN.root/demo/fgenTree");
...
Class_qqbar2gg::~Class_qqbar2gg()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Class_qqbar2gg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Class_qqbar2gg::LoadTree(Long64_t entry)
{
...
void Class_qqbar2gg::Init(TTree *tree)
{
...
void Class_qqbar2gg::Show(Long64_t entry)
{
...
Int_t Class_qqbar2gg::Cut(Long64_t entry)
{
...
#endif // #ifdef Class_qqbar2gg_cxx
