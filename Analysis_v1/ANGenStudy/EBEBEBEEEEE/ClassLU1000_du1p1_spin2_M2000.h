...
#ifndef ClassLU1000_du1p1_spin2_M2000_h
#define ClassLU1000_du1p1_spin2_M2000_h
...
class ClassLU1000_du1p1_spin2_M2000 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ClassLU1000_du1p1_spin2_M2000(TTree *tree=0);
   virtual ~ClassLU1000_du1p1_spin2_M2000();
...
#ifdef ClassLU1000_du1p1_spin2_M2000_cxx
ClassLU1000_du1p1_spin2_M2000::ClassLU1000_du1p1_spin2_M2000(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/uscms_data/d3/cuperez/CMSSW_9_3_8/src/multiphoton-analysis/nPhotonAnalyzer/out/TestFinMCIUnp_LU1000p0_du1p1_spin-2_M_2000_py_GEN.root/demo/fgenTree");
...
ClassLU1000_du1p1_spin2_M2000::~ClassLU1000_du1p1_spin2_M2000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ClassLU1000_du1p1_spin2_M2000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassLU1000_du1p1_spin2_M2000::LoadTree(Long64_t entry)
{
...
void ClassLU1000_du1p1_spin2_M2000::Init(TTree *tree)
{
...
Bool_t ClassLU1000_du1p1_spin2_M2000::Notify()
{
...
void ClassLU1000_du1p1_spin2_M2000::Show(Long64_t entry)
{
...
Int_t ClassLU1000_du1p1_spin2_M2000::Cut(Long64_t entry)
{
...
#endif // #ifdef ClassLU1000_du1p1_spin2_M2000_cxx
