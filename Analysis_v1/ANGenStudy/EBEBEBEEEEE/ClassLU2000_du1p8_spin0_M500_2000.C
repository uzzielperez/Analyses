#define ClassLU2000_du1p8_spin0_M500_2000_cxx
#include "ClassLU2000_du1p8_spin0_M500_2000.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <math.h>
...
void ClassLU2000_du1p8_spin0_M500_2000::Loop()
{
   if (fChain == 0) return;
  ...
  TString logfile = "ALLlog.txt";
	TString fileout_name = "OUTLU2000_du1p8_spin0_M500_2000.root"; double xsec = 0.1191384;
