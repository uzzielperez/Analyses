...
#ifndef ClassLU5000_du1p5_spin0_M500_2000_h
#define ClassLU5000_du1p5_spin0_M500_2000_h
...
class ClassLU5000_du1p5_spin0_M500_2000 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ClassLU5000_du1p5_spin0_M500_2000(TTree *tree=0);
   virtual ~ClassLU5000_du1p5_spin0_M500_2000();
...
#ifdef ClassLU5000_du1p5_spin0_M500_2000_cxx
ClassLU5000_du1p5_spin0_M500_2000::ClassLU5000_du1p5_spin0_M500_2000(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/uscms_data/d3/cuperez/CMSSW_9_3_8/src/multiphoton-analysis/nPhotonAnalyzer/out/TestFinMCIUnp_LU5000p0_du1p5_spin-0_M_500-2000_py_GEN.root/demo/fgenTree");
...
ClassLU5000_du1p5_spin0_M500_2000::~ClassLU5000_du1p5_spin0_M500_2000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ClassLU5000_du1p5_spin0_M500_2000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassLU5000_du1p5_spin0_M500_2000::LoadTree(Long64_t entry)
{
...
void ClassLU5000_du1p5_spin0_M500_2000::Init(TTree *tree)
{
...
Bool_t ClassLU5000_du1p5_spin0_M500_2000::Notify()
{
...
void ClassLU5000_du1p5_spin0_M500_2000::Show(Long64_t entry)
{
...
Int_t ClassLU5000_du1p5_spin0_M500_2000::Cut(Long64_t entry)
{
...
#endif // #ifdef ClassLU5000_du1p5_spin0_M500_2000_cxx
