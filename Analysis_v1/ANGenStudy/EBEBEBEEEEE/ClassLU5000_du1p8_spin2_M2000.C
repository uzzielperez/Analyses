#define ClassLU5000_du1p8_spin2_M2000_cxx
#include "ClassLU5000_du1p8_spin2_M2000.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <math.h>
...
void ClassLU5000_du1p8_spin2_M2000::Loop()
{
   if (fChain == 0) return;
  ...
  TString logfile = "ALLlog.txt";
	TString fileout_name = "OUTLU5000_du1p8_spin2_M2000.root"; double xsec = 0.000485627;
