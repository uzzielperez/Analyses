#define ClassLU1000_du1p5_spin0_M2000_cxx
#include "ClassLU1000_du1p5_spin0_M2000.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <math.h>
...
void ClassLU1000_du1p5_spin0_M2000::Loop()
{
   if (fChain == 0) return;
  ...
  TString logfile = "ALLlog.txt";
	TString fileout_name = "OUTLU1000_du1p5_spin0_M2000.root"; double xsec = 0.00599191;
