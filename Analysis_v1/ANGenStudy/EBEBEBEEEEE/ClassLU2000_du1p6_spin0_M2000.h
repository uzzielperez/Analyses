...
#ifndef ClassLU2000_du1p6_spin0_M2000_h
#define ClassLU2000_du1p6_spin0_M2000_h
...
class ClassLU2000_du1p6_spin0_M2000 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ClassLU2000_du1p6_spin0_M2000(TTree *tree=0);
   virtual ~ClassLU2000_du1p6_spin0_M2000();
...
#ifdef ClassLU2000_du1p6_spin0_M2000_cxx
ClassLU2000_du1p6_spin0_M2000::ClassLU2000_du1p6_spin0_M2000(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/uscms_data/d3/cuperez/CMSSW_9_3_8/src/multiphoton-analysis/nPhotonAnalyzer/out/TestFinMCIUnp_LU2000p0_du1p6_spin-0_M_2000_py_GEN.root/demo/fgenTree");
...
ClassLU2000_du1p6_spin0_M2000::~ClassLU2000_du1p6_spin0_M2000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ClassLU2000_du1p6_spin0_M2000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassLU2000_du1p6_spin0_M2000::LoadTree(Long64_t entry)
{
...
void ClassLU2000_du1p6_spin0_M2000::Init(TTree *tree)
{
...
Bool_t ClassLU2000_du1p6_spin0_M2000::Notify()
{
...
void ClassLU2000_du1p6_spin0_M2000::Show(Long64_t entry)
{
...
Int_t ClassLU2000_du1p6_spin0_M2000::Cut(Long64_t entry)
{
...
#endif // #ifdef ClassLU2000_du1p6_spin0_M2000_cxx
