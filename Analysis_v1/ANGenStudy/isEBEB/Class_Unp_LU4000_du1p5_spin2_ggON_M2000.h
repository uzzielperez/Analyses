...
#ifndef Class_Unp_LU4000_du1p5_spin2_ggON_M2000_h
#define Class_Unp_LU4000_du1p5_spin2_ggON_M2000_h
...
class Class_Unp_LU4000_du1p5_spin2_ggON_M2000 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Class_Unp_LU4000_du1p5_spin2_ggON_M2000(TTree *tree=0);
   virtual ~Class_Unp_LU4000_du1p5_spin2_ggON_M2000();
...
#ifdef Class_Unp_LU4000_du1p5_spin2_ggON_M2000_cxx
Class_Unp_LU4000_du1p5_spin2_ggON_M2000::Class_Unp_LU4000_du1p5_spin2_ggON_M2000(TTree *tree) : fChain(0)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/uscms_data/d3/cuperez/CMSSW_9_3_8/src/multiphoton-analysis/nPhotonAnalyzer/out/TesttMCIPlus2_Unp-LU4000-du1p5_spin-2-ggON_pT125_M_2000_TuneCP2_py_GEN.root/demo/fgenTree");
...
Class_Unp_LU4000_du1p5_spin2_ggON_M2000::~Class_Unp_LU4000_du1p5_spin2_ggON_M2000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Class_Unp_LU4000_du1p5_spin2_ggON_M2000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Class_Unp_LU4000_du1p5_spin2_ggON_M2000::LoadTree(Long64_t entry)
{
...
void Class_Unp_LU4000_du1p5_spin2_ggON_M2000::Init(TTree *tree)
{
...
Bool_t Class_Unp_LU4000_du1p5_spin2_ggON_M2000::Notify()
{
...
void Class_Unp_LU4000_du1p5_spin2_ggON_M2000::Show(Long64_t entry)
{
...
Int_t Class_Unp_LU4000_du1p5_spin2_ggON_M2000::Cut(Long64_t entry)
{
...
#endif // #ifdef Class_Unp_LU4000_du1p5_spin2_ggON_M2000_cxx
