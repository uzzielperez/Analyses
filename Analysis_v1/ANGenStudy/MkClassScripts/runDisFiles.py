...
if do1p83Test:
    du_tag = "1p8"
    DATASET.append("TestSTest1p8Unp1500p0_spin-0_M_500-2000_py_GEN.root/demo/fgenTree")
    DATASET.append("TestSTest1p8Unp1500p0_spin-0_M_2000_py_GEN.root/demo/fgenTree")
    # DATASET.append("TestSTest1p8Unp2500p0_spin-0_M_500-2000_py_GEN.root/demo/fgenTree")
    # DATASET.append("TestSTest1p8Unp2500p0_spin-0_M_2000_py_GEN.root/demo/fgenTree")
    # DATASET.append("TestSTest1p8Unp4000p0_spin-0_M_500-2000_py_GEN.root/demo/fgenTree")
    # DATASET.append("TestSTest1p8Unp4000p0_spin-0_M_2000_py_GEN.root/demo/fgenTree")
...
if do1p93Test:
    du_tag = "1p9"
    DATASET.append("TestSTest1p9Unp1500p0_spin-0_M_500-2000_py_GEN.root/demo/fgenTree")
    DATASET.append("TestSTest1p9Unp1500p0_spin-0_M_2000_py_GEN.root/demo/fgenTree")
    DATASET.append("TestSTest1p9Unp2500p0_spin-0_M_500-2000_py_GEN.root/demo/fgenTree")
    DATASET.append("TestSTest1p9Unp2500p0_spin-0_M_2000_py_GEN.root/demo/fgenTree")
    DATASET.append("TestSTest1p9Unp4000p0_spin-0_M_500-2000_py_GEN.root/demo/fgenTree")
    DATASET.append("TestSTest1p9Unp4000p0_spin-0_M_2000_py_GEN.root/demo/fgenTree")
