...
#ifndef DiPhoton16BKG_h
#define DiPhoton16BKG_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   DiPhoton16BKG(TTree *tree=0);
   virtual ~DiPhoton16BKG();
...
#ifdef DiPhoton16BKG_cxx
DiPhoton16BKG::DiPhoton16BKG(TTree *tree) : fChain(0) 
{
...
DiPhoton16BKG::~DiPhoton16BKG()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DiPhoton16BKG::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DiPhoton16BKG::LoadTree(Long64_t entry)
{
...
void DiPhoton16BKG::Init(TTree *tree)
{
...
void DiPhoton16BKG::Show(Long64_t entry)
{
...
Int_t DiPhoton16BKG::Cut(Long64_t entry)
{
